...
if (iDissectionOption == 0)
   ...
   ; akTarget.DropObject(arCorpseMiscBodyParts[0], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[1], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[2], 2)
   ; akTarget.DropObject(arCorpseMiscBodyParts[3], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[4], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[5], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[6], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[7], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[8], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[9], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[10], 1)
   ; akTarget.DropObject(arCorpseMiscBodyParts[11], 1)
   ; akTarget.DropObject(arEdibleBodyParts[0], 1)
   ; akTarget.DropObject(arEdibleBodyParts[1], iHarvestedMeat)
   ; akTarget.DropObject(arEdibleBodyParts[2], 2)
